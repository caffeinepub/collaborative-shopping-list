...
export class Backend implements backendInterface {
    ...
    async addItem(arg0: string, arg1: number | null, arg2: string | null, arg3: string): Promise<ShoppingItem> {
        if (this.processError) {
            try {
                const result = await this.actor.addItem(arg0, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg2), arg3);
                return from_candid_ShoppingItem_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async clearPurchased(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.clearPurchased();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getItems(): Promise<Array<ShoppingItem>> {
        if (this.processError) {
            try {
    ...
    async isAnonymous(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isAnonymous(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async togglePurchased(arg0: bigint): Promise<ShoppingItem> {
        if (this.processError) {
            try {
                const result = await this.actor.togglePurchased(arg0);
                return from_candid_ShoppingItem_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateItem(arg0: bigint, arg1: string, arg2: number | null, arg3: string | null, arg4: string): Promise<ShoppingItem> {
        if (this.processError) {
            try {
                const result = await this.actor.updateItem(arg0, arg1, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg3), arg4);
                return from_candid_ShoppingItem_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ShoppingItem_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ShoppingItem): ShoppingItem {
...
function from_candid_record_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        quantity: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.quantity)),
...
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ShoppingItem>): Array<ShoppingItem> {
    return value.map((x)=>from_candid_ShoppingItem_n3(_uploadFile, _downloadFile, x));
}
